...
import com.yarolegovich.slidingrootnav.sample.fragment.FragmentOne;
import com.yarolegovich.slidingrootnav.sample.fragment.FragmentTwo;
...
public class SampleActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    public void onItemSelected(int position) {
        ...
        if (position == 0) {
            ...
            Fragment selectedScreen = FragmentOne.createFor();
            showFragment(selectedScreen);
        }
        else if(position == 2) {
            Fragment selectedScreen = FragmentTwo.createFor();
            showFragment(selectedScreen);
        }
